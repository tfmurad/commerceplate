    ...
    <ul className={className}>
      ...
      <li>
        <a className="cursor-pointer relative" onClick={handleCopyLink} aria-label="Copy Link">
          ...
          {isTooltipVisible && <span className="text-xs absolute -right-16 text-text whitespace-nowrap"><DynamicIcon className="inline-block text-green-500" icon={"FaLink"} /> copied!</span>}
